...
Public Class Launcher
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Shell("Explorer.exe fivem://connect/167.114.97.53:30120")
    End Sub

    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        Shell("Explorer.exe https://discord.com/invite/ddcKxBv")
    End Sub

    Private Sub gotoTS_Click(sender As Object, e As EventArgs) Handles gotoTS.Click
        Shell("Explorer.exe ts3server://167.114.97.53")
    End Sub
    ...
    Private Sub Beta_Click(sender As Object, e As EventArgs)
